            ...
            <form action="index.php?page=profile" method="post">
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="text" id="first_name" name="first_name"
                            value="<?= get_field_value($userdata, 'first_name') ?>" required>
                    </div>
                    <div class="form-field">
                        <label for="last_name">Nachname:</label>
                        <!-- Wert aus $userdata['last_name'] -->
                        <input type="text" id="last_name" name="last_name"
                            value="<?= get_field_value($userdata, 'last_name') ?>" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="email" id="email" name="email" value="<?= get_field_value($userdata, 'email') ?>"
                            required>
                    </div>
                    <div class="form-field">
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="text" id="street" name="street"
                            value="<?= get_field_value($addressdata, 'street') ?>">
                    </div>
                    <div class="form-field">
                        <label for="zip">PLZ:</label>
                        <!-- Wert aus $addressdata['postal_code'] -->
                        <input type="text" id="zip" name="zip"
                            value="<?= get_field_value($addressdata, 'postal_code') ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-field" style="width:100%;">
                        ...
                        <select id="gender" name="gender">
                            ...
                            <option value="female" <?= ($selectedGender === 'female') ? 'selected' : '' ?>>Weiblich
                            </option>
                ...
                <div class="form-row">
                    <div class="form-field" style="width:100%;">
                        ...
                        <input type="text" id="country" name="country"
                            value="<?= get_field_value($addressdata, 'country', 'Deutschland') ?>">
                    </div>
                </div>
